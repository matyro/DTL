...
namespace test
{
    namespace algorithm
    {
        ...
        struct testStatic1 : public MooreStateStatic<char,1>
        {
        public:
            std::vector<char> vec;
        ...
        struct testStatic2 : public MooreStateStatic<char,1>
        {
        public:
            std::vector<char> vec;
        ...
        TEST(MooreStateMachine, StaticMachineTest)
        {
            ...
            auto m1 = MooreStateMachine<char, testStatic1, testStatic2>( testStatic1(), testStatic2() );
        ...
        struct testDynamic1 : public MooreStateDynamic<char>
        {
        public:
            std::vector<char> vec;
        ...
        struct testDynamic2 : public MooreStateDynamic<char>
        {
        public:
            std::vector<char> vec;
